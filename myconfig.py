...
# """
COPILOT_ENABLE = True                                  # GLOBAL - ON/OFF
COPILOT_HW_INFO = False                                 # SHOW HZ and ina219 info
COPILOT_AUDIO_ENABLE = True

###
# TRANSFORM
###
COPILOT_TRANSFORM = False                               # TRANSFORM IMAGE
COPILOT_TRANSFORM_PERFMON = True
COPILOT_TRANSFORM_LIST_ALL=['warp','cornercut','medianBlur','reverse','brightContrast','laplacian']
COPILOT_TRANSFORM_LIST=['warp',"laplacian",'cornercut']            # liste des transform a appliquer

COPILOT_LAPLACIAN_BLUR = 9
COPILOT_LAPLACIAN_THRES_LOW = 90
COPILOT_LAPLACIAN_THRES_HIGH = 255
COPILOT_LAPLACIAN_DEPTH = 3
COPILOT_LAPLACIAN_SHARPEN_CENTER = 0
COPILOT_LAPLACIAN_SHARPEN_DIAG = 2
COPILOT_LAPLACIAN_SHARPEN_CROSS = 2

# WARPING - trapezoid
COPILOT_WARP_PADDING_TOP = 0.5                         # % de l'image a enlever en haut
COPILOT_WARP_PADDING_BOTTOM = .1                       # % de l'image a enlever en bas
COPILOT_WARP_PADDING_WIDTH_BACK = .0                   # % du padding trapeze back
COPILOT_WARP_PADDING_WIDTH_FRONT= .0                   # % du padding trapeze front
...
#protoxyde - acceleration en ligne droite
COPILOT_PROTOXYDE = True                               # activation du mode 
COPILOT_PROTOXYDE_DEBUG = False
COPILOT_PROTOXYDE_THROTTLE_MULT = 0.90                 # coeff de base - vitesse minimale x1
COPILOT_PROTOXYDE_ACCELERATION = .04                   # increment du coeff multiplicateur par cycle 
COPILOT_PROTOXYDE_DECELERATION = 5                     # décrément du coeff multiplicateur par cycle
COPILOT_PROTOXYDE_NB_SAMPLE = 4
COPILOT_PROTOXYDE_COEFF_MAX = 1.10                     # valeur max du coefficient multiplicateur
COPILOT_PROTOXYDE_THRESHOLD_HIGH = 0.25                # valeur absolue de l'angle qui activera le ralentissement
COPILOT_PROTOXYDE_THRESHOLD_LOW = 0.12                 # valeur absolue de l'angle qui activera l'accélération
COPILOT_PROTOXYDE_ANGLE_LOW_COEF = 1.10                # coef multiplicateur - on braque 
COPILOT_PROTOXYDE_THROTTLE_MIN = 0.185                 # vitesse minimale

###
# CONTROL STEPS, START/STOP
###
COPILOT_STEPCOUNTER = True                             # DETECT LAP strat & stop
COPILOT_STEPCOUNTER_AUDIO = True                       # Enable audio
COPILOT_SKIP_GREEN = False                             # Skip green detection
COPILOT_AUTOSTART = True                               # INIT new race on start
COPILOT_STEPS=['start','lap','lap','lastlap']
COPILOT_STEPS_CONFIG={
    "default":{
        "freq_loop":.1,
        "pxl_raw": 400000,
        "race_state":"local",
    ...
    "start":{ "waitBefore":4, "colorRange":"green", "crop_region":'all' },
    "lap":{},
    "lastlap":{ "race_state": "user" }
}
# alias du croping de steps
COPILOT_CROP_REGION={
    "all":[0,1,0,1],
    "top_right":[0,.5,.5,1],
    "bottom_right":[.5,1,.5,1],
    "bottom_left":[.5,1,0,.5],
    "top_left":[0,.5,0,.5],
    "left":[0,1,0,.5],
    "top":[0,.5,0,1],
...
# filter color range for steps
COPILOT_COLOR_FILTER = { 
    "green":{"lower":(65, 60, 60),"upper":(80, 255,255)},
    "yellow":{"lower":(22, 39, 0),"upper":(45, 255,255)}
    }
COPILOT_AUDIO_VOLUME = 15 # volume increase
COPILOT_AUDIO_ACTION= {
    "init":{"title":"/home/pi/picar/copilot/audio/init.mp3","startpos":0,"timetoplay":2,"volume":COPILOT_AUDIO_VOLUME},
    "lap":{"title":"/home/pi/picar/copilot/audio/mario_coin.mp3","startpos":0,"timetoplay":.2,"volume":COPILOT_AUDIO_VOLUME},
    "start":{"title":"/home/pi/picar/copilot/audio/MK64.mp3","startpos":0,"timetoplay":6,"volume":COPILOT_AUDIO_VOLUME},
    "end":{"title":"/home/pi/picar/copilot/audio/course_clear.mp3","startpos":0,"timetoplay":4,"volume":COPILOT_AUDIO_VOLUME}
}
